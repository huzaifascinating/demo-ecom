...
import { FaStar, FaCheck, FaArrowLeft, FaMagic, FaClock, FaLeaf, FaFlask, FaShoppingBag, FaCcVisa, FaCcMastercard, FaCcAmex, FaRegCircle, FaDotCircle, FaChevronDown, FaTimes, FaArrowRight, FaCheckCircle } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-[#FCFAF8] text-stone-800 selection:bg-pink-100">
      ...
      <main className="pb-24">
        ...
        <section className="mt-10 relative overflow-hidden">
          <div className="bg-pink-50 rounded-[2rem] py-16 md:py-10 relative">
        ...
        <section className="py-24 bg-white overflow-hidden mt-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                  ...
                  <div className="grid grid-cols-2">
                    ...
                    <div className="bg-gradient-to-b from-pink-50 to-pink-100 p-8 md:p-12 border-r border-stone-100">
                      <div className="text-center mb-10">
                        <h3 className="text-2xl md:text-3xl font-black text-stone-900 tracking-tighter uppercase italic">
                          Lorena
                        </h3>
                      </div>
                      ``
                    ...
                    <div className="bg-stone-50/50 p-8 md:p-12">
                      <div className="text-center mb-10">
                        <h4 className="text-xl md:text-2xl font-bold text-stone-400 tracking-tight">Others</h4>
                      </div>
              ...
              <div className="lg:col-span-5 space-y-8">
                ...
                <h2 className="text-3xl md:text-5xl font-serif font-semibold text-gray-900 leading-tight">
                  Why The <span className="font-serif text-transparent bg-clip-text bg-linear-to-r from-pink-400 to-purple-400 italic">NOVA LIFT</span> MicroGlow?
                </h2>
                ...
                <div className="pt-4 flex flex-col items-start space-y-4">
                  <Link
                    to="/shop"
                    className="group flex items-center justify-center gap-3 bg-linear-to-tr from-pink-500 to-purple-400 text-white text-xl font-bold py-5 px-16 rounded-full hover:bg-gray-800 hover:scale-102 transition-all shadow-xl hover:shadow-2xl uppercase tracking-wider w-full sm:w-auto text-center"
                  >
